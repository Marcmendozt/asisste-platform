    ...
    xhr.onreadystatechange = function () {
        ...
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            if (Respuesta != null) {
                ...
                Data = Respuesta.Data;
                //TraerDataTipoDocumento(Respuesta.Data);
                changePage(1);
                current_page = 1;
...
var divTBTipoDocumento = document.getElementById("divTBTipoDocumento");
...
function changePage(page) {
    ...
    Contenido += "<table id='IDTBTipoDocumento' class='table table-bordered'>";
    Contenido += "<thead>";
    Contenido += "<tr>";
    Contenido += "<th>#</th>";
    Contenido += "<th>DESCRIPCIÓN</th>";
    Contenido += "<th>LONGITUD</th>";
    ...
    for (var i = (page - 1) * records_per_page; i < (page * records_per_page) && i < Data.length; i++) {
        ...
        Contenido += "<td>" + Data[i].Longitud + "</td>";
        if (Data[i].ID_Estado == true) {
            Contenido += "<td>";
        ...
        Contenido += "<td>";
        Contenido += "<a class='material-icons'; onclick='AbrirEditar(" + Data[i].ID_TipoDocumento + " )'> edit </a>";
        Contenido += "<a id='#Eliminar' class='material-icons' onclick='ModalEliminar(" + Data[i].ID_TipoDocumento + " )'>delete</a>";
        Contenido += "</td>";
    }
    Contenido += "</tr>";
    Contenido += "</tbody>";
    Contenido += "</table>";
    Contenido += "</div>";
    divTBTipoDocumento.innerHTML = Contenido;
